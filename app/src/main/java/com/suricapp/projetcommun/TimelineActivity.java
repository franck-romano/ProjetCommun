    ...
    private void addDrawerItems(){
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        Intent message = new Intent(TimelineActivity.this, NewMessage.class);
                        startActivity(message);
                        break;
                    case 1:
                        Intent timeline = new Intent(TimelineActivity.this, TimelineActivity.class);
                        startActivity(timeline);
                        break;
                    case 2:
                        Intent map = new Intent(TimelineActivity.this, MapActivity.class);
                        startActivity(map);
                        break;
                    case 3:
                        Intent profil = new Intent(TimelineActivity.this, ProfilActivity.class);
                    ...
                    /*case 3:
                        ...
                        break;*/
                    case 5:
                        Intent categorie = new Intent(TimelineActivity.this, CategoriesActivity.class);
